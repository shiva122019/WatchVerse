...
export default function Login() {
  ...
  return (
    <div
      className="relative flex min-h-screen items-start justify-center overflow-hidden px-6 pt-6 md:pt-8"
      data-testid="login-page"
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, rgba(0,240,255,0.09), transparent 50%), radial-gradient(circle at 70% 70%, rgba(255,179,0,0.03), transparent 50%), linear-gradient(180deg, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.3) 35%, rgba(0,0,0,0.7) 100%)",
        }}
      />
