...
import { Copy, Check, LogOut, Users, MessageCircle, Film, Sparkles, Search, Shuffle, ArrowLeft, Lock, UserPlus } from "lucide-react";
      ...
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
        <main className="relative flex min-h-0 flex-1 flex-col items-center justify-center gap-4 p-4">
          <div className="absolute left-6 top-6 z-10 flex items-center gap-2">
            <span className="flex items-center gap-1.5 rounded-full border border-white/10 bg-black/60 px-3 py-1.5 text-xs uppercase tracking-widest text-neutral-400 backdrop-blur">
          ...
          <div className="absolute right-6 top-6 z-10 flex items-center gap-2">
            <button
              onClick={copyLink}
              className="flex items-center gap-2 rounded-full border border-white/10 bg-black/60 px-4 py-2 text-sm backdrop-blur hover:bg-white/10"
            >
            ...
            <button
              onClick={leaveRoom}
              className="flex items-center gap-2 rounded-full border border-white/10 bg-black/60 px-4 py-2 text-sm text-neutral-300 backdrop-blur hover:bg-white/10"
            >
              ...
              <div className="flex h-full w-full flex-col items-center justify-center gap-4">
                {movie.trailerKey ? (
                  <TrailerPlayer
                    ...
                    onChangeMovie={() => setShowSearch(true)}
